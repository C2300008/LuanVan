 ...
 * @property {mongoose.Schema.Types.ObjectId} nv_ID - Khóa ngoại, mã nhân viên thực hiện xác thực.
 * @property {mongoose.Schema.Types.ObjectId} nd_ID - Khóa ngoại, mã người dùng được xác thực.
